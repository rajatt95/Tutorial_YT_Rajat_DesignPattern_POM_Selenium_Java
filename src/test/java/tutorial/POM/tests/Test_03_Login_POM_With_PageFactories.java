...
import tutorial.POM.pages._03_With_PageFactories.HomePage;
import tutorial.POM.pages._03_With_PageFactories.LoginPage;

/**
 * This is a test class that contains test cases for the login functionality using the
 * Page Object Model (POM) with PAGE FACTORIES.
 */
public class Test_03_Login_POM_With_PageFactories extends BaseTest {

    // Test_03_Login_POM_With_PageFactories extends BaseTest - This is the example of INHERITANCE (OOPS Concept) - Single-level inheritance
