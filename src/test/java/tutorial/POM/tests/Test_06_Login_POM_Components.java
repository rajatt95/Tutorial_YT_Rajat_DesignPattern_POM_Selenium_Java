...
import tutorial.POM.pages._06_HandleComponents.HomePage;
import tutorial.POM.pages._06_HandleComponents.LoginPage;
...
public class Test_06_Login_POM_Components extends BaseTest {
    ...
    public void test_Login_Functionality_Valid_Credentials(){
        ...
        Assert.assertEquals(homePage.getAppHeader().get_Element_Heading_SwagLabs().isDisplayed(), true,
                "Assertion for Heading: Swag Labs presence in the Header");
